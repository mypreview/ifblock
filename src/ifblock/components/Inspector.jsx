...
export default class Inspector extends Component {
	render() {
		const { className, attributes, setAttributes, rolesList, browsersList } = this.props;
					...
					<PanelBody initialOpen={ true }>
						{ !! role && !! browser && (
							<BaseControl
								...
								label={ _x( 'Operator', 'control label', 'ifblock' ) }
								help={
									'and' === operator
										? _x(
							...
							>
								<ButtonGroup aria-label={ _x( 'Conditional operator', 'aria label', 'ifblock' ) }>
									<Button
										isSmall
										isPrimary={ 'and' === operator ? true : false }
										onClick={ () =>
											setAttributes( {
												operator: 'and',
											} )
									...
									<Button
										isSmall
										isPrimary={ 'or' === operator ? true : false }
										onClick={ () =>
											setAttributes( {
												operator: 'or',
											} )
						...
						<SelectControl
							label={ _x( 'User Role', 'control label', 'ifblock' ) }
							help={ _x(
						...
						/>
						<SelectControl
							label={ _x( 'Browser', 'control label', 'ifblock' ) }
							help={ _x(
